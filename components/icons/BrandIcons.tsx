// Minimal monochrome brand marks, used only to link out to the
// person's own GitHub/LinkedIn profiles — inherits currentColor so it
// themes with the surrounding text automatically.
